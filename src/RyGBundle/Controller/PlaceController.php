...
class PlaceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $places = $em->getRepository('RyGBundle:Place')->findAll();
    ...
    {
        $place = new Place();
        $form = $this->createForm('RyGBundle\Form\PlaceType', $place);
    ...
    {
        $deleteForm = $this->createDeleteForm($place);
        $editForm = $this->createForm('RyGBundle\Form\PlaceType', $place);
